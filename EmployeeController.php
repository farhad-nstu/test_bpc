                ...
                <form method="post" action="{{url($bUrl.'/store')}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="employee_mobile">Mobile No</label>
                                <div class="col-sm-8">
                    ...
                    <div id="checkSpouse">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="spouse_dist">Home Districet</label>
                                    <div class="col-sm-8">
