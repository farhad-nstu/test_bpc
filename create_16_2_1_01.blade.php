            ...
            <div class="col-md-11">
                ...
                <form method="post" action="{{url($bUrl.'/store')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-check mx-2 mt-2">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="employee_marital_state" onclick="check_spouse(1)" value="1"  id="flexCheckChecked" checked>
                                    @else
                                ...
                                <div class="form-check mt-2">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="employee_marital_state" onclick="check_spouse(2)" value="2"  id="flexCheckDefault" checked>
                                    @else
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <textarea name="employee_present_address" id="employee_present_address"   class="form-control" rows="2" placeholder="Enter ..." style="margin-top: 0px; margin-bottom: 0px; height: 150px;">{{getValue('employee_present_address',$objData)}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <textarea name="employee_permanent_address" id="employee_permanent_address"   class="form-control" rows="2" placeholder="Enter ..." style="margin-top: 0px; margin-bottom: 0px; height: 150px;">{{getValue('employee_permanent_address',$objData)}}</textarea>
                        </div>
                    </div>
                    <br>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr id="myChildRow">
                                        ...
                                        <td>
                                            <input value="" name="child_birth[]" id="child_birth" type="text" class="form-control">
                                        </td>
                                        <td>
                                            <input value="" name="child_sex[]" id="child_sex" type="text" class="form-control">
                                        </td>
                                        <td>
                        ...
                        <div class="row">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr id="myLangRow">
                                        <td>
                                            <input value="" name="lang_name[]" id="lang_name" type="text" class="form-control">
                                        </td>
                                        <td>
                                            <input value="" name="readLang[]" id="readLang" type="text" class="form-control">
                                        </td>
                                        <td>
                                            <input value="" name="writeLang[]" id="writeLang" type="text" class="form-control">
                                        </td>
                                        <td>
                                            <input value="" name="speakLang[]" id="speakLang" type="text" class="form-control">
                                        </td>
                                        <td>
