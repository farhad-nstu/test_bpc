    ...
    <div class="card-body" id="">
      ...
      <div class="col-md-10">
        ...
        <form action="{{url($bUrl)}}" method="get" class="form-inline">
          ...
          <div class="form-row">
            <div class="col">
              <input type="text" name="filter" value="{{ $filter ?? '' }}" placeholder="Filter by hotel name..."
            ...
            <table class="table table-bordered">
              <thead>
                <tr>
                  ...
                  <th class="sort" data-row="name" id="name">Employee Name</th>
                  <th>Employee ID</th>
                  <th class="sort" data-row="location" id="location">Employee Designation</th>
                  <th>Employee Posting</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {{ ($designation->desg_id == $data->employee_designation)? $designation->desg_title:'' }}
                    @endforeach
                  </td>
                  <td>{{ $data->employee_posting }}</td>
                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" role="menu" style="">
                        ...
                        <a class="dropdown-item" id="action" data-toggle="modal" data-target="#windowmodal"
                          href="{{url($bUrl.'/delete/'.$data->$tableID)}}"><i class="fa fa-edit"></i> Delete</a>
