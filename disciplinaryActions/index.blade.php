        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <button type="button" class="btn btn-tool">
                    <a href="{{url($bUrl.'/create')}}" class="btn bg-gradient-info btn-sm custom_btn"><i
                            class="mdi mdi-plus"></i> <i class="fa fa-plus-circle"></i> Add New </a>
                </button>
            </div>
        </div>
                    ...
                    <div class="form-row">
                        <div class="col">
                            <input type="text" name="filter" value="{{ $filter ?? '' }}"
                                placeholder="Filter by hotel name..." class="form-control float-left search_input" />
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th>SL</th>
                                    <th class="sort" data-row="name" id="name">Employee</th>
                                    <th class="sort" data-row="name" id="name">Nature Of Offense</th>
                                    <th class="sort" data-row="location" id="location">Date</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $data->nature_of_offense }}</td>
                                    <td>{{ $data->dis_date }}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-outline-info">
                                                <a href="{{url($bUrl.'/'.$data->$tableID.'/view')}}"><i
                                                        class="fa fa-table"></i> </a>
                                            </button>

                                            <button type="button"
                                                class="btn btn-outline-info dropdown-toggle dropdown-hover dropdown-icon"
                                                data-toggle="dropdown">
                                            </button>
                                            <div class="dropdown-menu" role="menu" style="">
                                                <a class="dropdown-item"
                                                    href="{{url($bUrl.'/'.$data->$tableID.'/edit')}}"><i
                                                        class="fa fa-edit"></i> Edit</a>

                                                <div class="dropdown-divider"></div>

                                                <a class="dropdown-item" id="action" data-toggle="modal"
                                                    data-target="#windowmodal"
                                                    href="{{url($bUrl.'/delete/'.$data->$tableID)}}"><i
                                                ...
                                                <form action="{{url($bUrl.'/'.$data->$tableID)}}" method="POST">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button class="dropdown-item sweet" type="submit"><i
