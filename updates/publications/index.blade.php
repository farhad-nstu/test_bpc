            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="" width="20%">Publication Type</th>
                  <th class="" width="25%">Date of Publicatin</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="25%">{{ $data->employee_name }}</td>
                  <td class="text-center" width="10%">{{ $data->employee_bpc_id }}</td>
                  <td class="pl-1" width="25%">{{ $data->publication_type }}</td>
                  <td class="pl-1" width="25%">{{ $data->publication_date }}</td>
