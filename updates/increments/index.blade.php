  ...
  <div class="card">
    <div class="card-header">
      ...
      <div class="card-tools">
        ...
        <!-- <button type="button" class="btn btn-tool">
          <a href="{{url('/hrms/auto-increment')}}" class="btn bg-gradient-info btn-sm custom_btn"><i class="mdi mdi-plus"></i>
            <i class="fa fa-plus-circle"></i> Bulk Increment </a>
        </button> -->
        <button type="button" class="btn btn-tool">
          <a href="{{url('/hrms/bulk/increment-overview')}}" class="btn bg-gradient-info btn-sm custom_btn"><i class="mdi mdi-plus"></i>
            <i class="fa fa-plus-circle"></i> Bulk Increment </a>
        </button>
            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="sort" data-row="name" id="name" width="25%">Employee</th>
                  <th class="text-center" width="15%">Employee ID</th>
                  <th class="text-center" width="10%">Increment Date</th>
                  <th class="text-right" width="15%">Previous Salary</th>
                  <th class="text-right" width="15%">Increment Salary</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="30%">{{ $data->employee_name }}</td>
                  <td class="text-center" width="15%">{{ $data->employee_bpc_id }}</td>
                  <td class="text-center" width="10%">{{ $data->increment_date }}</td>
                  <td class="text-right pr-1" width="15%">{{ $data->employee_basic_salary }}</td>
                  <td class="text-right pr-1" width="15%">{{ $data->increment_salary }}</td>
