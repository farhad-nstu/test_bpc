                  ...
                  <tr id="spouseRow">
                    ...
                    <td>
                      <input value="{{ $spouseData['spouse_org'][$i] }}" name="spouse_org[]" type="text"
                        class="form-control" id="spouse_org{{ $i }}">
                    </td>
                    <td>
                      <input value="{{ $spouseData['spouse_loc'][$i] }}" name="spouse_loc[]" type="text"
                        class="form-control" id="spouse_loc{{ $i }}">
                    </td>
                    <td>
                      @if($i > 0)
                    ...
                    <tr id="spouseRow">
                      <td class="text-center">
                        <input value="{{ $spouseData['spouse_name'] }}" name="spouse_name[]" id="spouse_name0" type="text"
                          class="form-control">
                      </td>
                      <td class="text-center">
                        <input value="{{ $spouseData['spouse_nid'] }}" name="spouse_nid[]" id="spouse_nid0" type="text"
                          class="form-control">
                      </td>
                      <td class="text-center">
                        <input value="{{ $spouseData['spouse_occup'] }}" name="spouse_occup[]" id="spouse_occup0" type="text"
                          class="form-control">
                      </td>
                      <td class="text-center">
                        <input value="{{ $spouseData['spouse_desg'] }}" name="spouse_desg[]" id="spouse_desg0" type="text"
                          class="form-control">
                      </td>
                      <td class="text-center">
                        <select name="spouse_dist[]" id="spouse_dist"
                      ...
                      <td class="text-center">
                        <input value="{{ $spouseData['spouse_org'] }}" name="spouse_org[]" id="spouse_org0" type="text"
                          class="form-control">
                      </td>
                      <td class="text-center">
                        <input value="{{ $spouseData['spouse_loc'] }}" name="spouse_loc[]" id="spouse_loc0" type="text"
                          class="form-control">
                      </td>
                      <td>
                        <button id="removeSpouseRow" type="button" class="removeSpouseRow btn btn-sm btn-danger"><i
            ...
            <div class="row">
              <table class="table table-bordered" id="childTable">
                ...
                <tbody id="childTbody">
                  ...
                  <tr id="myChildRow">
                    <td>
                      <input value="{{ $childData['child_name'][$i] }}" name="child_name[]" id="child_name{{ $i }}" type="text"
                        class="form-control">
                    </td>
                    <td>
                      <input value="{{ $childData['child_birth'][0] }}" name="child_birth[]" type="text"
                        class="form-control datepicker" autocomplete="off" id="child_birth{{ $i }}">
                    </td>
                    <td>
                    ...
                    <tr id="myChildRow">
                      <td class="text-center">
                        <input value="{{ $childData['child_name'] }}" name="child_name[]" id="child_name0" type="text"
                          class="form-control">
                      </td>
                      <td class="text-center">
                        <input value="{{ $childData['child_birth'] }}" name="child_birth[]" id="child_birth0" type="date"
                          class="form-control">
                      </td>
                      <td class="text-center">
  ...
  function check_spouse(spouseVal) {
    if (spouseVal == 2) {
      ...
      for(var i = 0; i < countSpouse; i++) {
        ...
        $("#spouse_nid"+i).val('');
        $("#spouse_name"+i).val('');
        $("#spouse_dist option").attr("selected", false);
        // $("#spouse_dist"+i).val('');
      }

      for(var i = 0; i < countChild; i++) {
        $("#child_sex option").attr("selected", false);
        $("#child_birth"+i).val('');
        $("#child_name"+i).val('');
      }
...
$(document).ready(function() {
  $('#addMoreSpouse').on('click', function() {
    var i = $("#spouseTable #spouseTbody input") .length + 1;
    var extSpouse =
      ...
      extSpouse += "<td class='text-center'><button id='removeSpouseRow' type='button' class='removeSpouseRow btn btn-sm btn-danger'><i class='fa fa-minus-circle'></i></button></td></tr>";
