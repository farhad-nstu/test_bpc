            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="" width="15%">Promotion</th>
                  <th class="text-center" width="10%">Previous Grade</th>
                  <th class="text-center" width="10%">Promoted Grade</th>
                  <th class="text-right" width="10%">Previous Salary</th>
                  <th class="text-right" width="10%">Promoted Salary</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="15%">{{ $data->promot_nature }}</td>
                  <td class="text-center" width="10%">Grade-{{ $data->previous_grade }}</td>
                  <td class="text-center" width="10%">Grade-{{ $data->promot_pay_scale }}</td>
                  <td class="text-right pr-1" width="10%">{{ $data->previous_salary }}</td>
                  <td class="text-right pr-1" width="10%">{{ $data->increment_salary }}</td>
