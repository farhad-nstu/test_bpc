    ...
    <div class="card-body" id="">
      ...
      <div class="col-md-10">
        ...
        <form action="{{url($bUrl)}}" method="get" class="form-inline">
          ...
          <div class="form-row">
            <div class="col">
              <input type="text" name="filter" value="{{ $filter ?? '' }}" placeholder="Filter by title or code..."
            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Payment Schedule</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">{{ $data->loan_code }}</td>
                  <td class="text-center">{{ $data->amount }}</td>
                  <td class="text-center">{{ $data->installment }}</td>
                  <td class="text-center">{{ $data->interest }}%</td>
                  <td class="text-center">{{ $data->payment_schedule }}</td>
                  <td class="text-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-outline-info">
                        <a data-toggle="modal" data-target="#windowmodal"
                              href="{{url($bUrl.'/'.$data->$tableID)}}"><i class="fa fa-table"></i> </a>
                      </button>
