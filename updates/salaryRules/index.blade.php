    ...
    <div class="card-body" id="">
      ...
      <div class="col-md-10">
        ...
        <form action="{{url($bUrl)}}" method="get" class="form-inline">
          ...
          <div class="form-row">
            <div class="col">
              <input type="text" name="filter" value="{{ $filter ?? '' }}" placeholder="Filter by title or code or type..."
            ...
            <table class="table table-bordered table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="20%"> {{ $data->rules_name }} </td>
                  <td class="text-center" width="15%">{{ $data->rules_code }}</td>
                  <td class="text-center" width="15%">{{ $data->rules_type }}</td>
                  <td class="text-center" width="15%">{{ $data->rules_status }}</td>
                  <td class="text-center" width="15%">
                    @if($data->is_fixed == 1)
                      {{ $data->rules_amount }}%
                    @else 
                      {{ $data->rules_amount }} BDT
                    @endif 
                  </td>
                  <td class="text-center" width="15%">
                    <div class="btn-group">
