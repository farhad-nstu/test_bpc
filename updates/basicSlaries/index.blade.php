            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="text-center" width="10%">Pay Scale</th>
                  <th class="text-right" width="10%">Basic Salary</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center" width="10%">Grade-{{ $data->employee_payscale_grade }}</td>
                  ...
                  <td class="text-center" width="10%">
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" role="menu" style="">
                        ...
                        <a class="dropdown-item" href="{{url($bUrl.'/'.$data->employee_bpc_id.'/edit')}}"><i
