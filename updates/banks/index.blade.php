            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="sort" data-row="name" id="name" width="30%">Employee</th>
                  <th class="text-center" width="15%">Employee ID</th>
                  <th class="" width="20%">A/C No</th>
                  <th class="" width="15%">Branch</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="20%">{{ $data->account_no }}</td>
                  <td class="pl-1" width="15%">{{ $data->branch }}</td>
                  <td class="text-center" width="15%">
                    <div class="btn-group">
                      <button type="button" class="btn btn-outline-info">
                        <a data-toggle="modal" data-target="#windowmodal"
                          href="{{url($bUrl.'/'.$data->bank_id)}}"><i class="fa fa-table"></i> </a>
                      </button>
