        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-4">
                <input class="form-control dateOfBirth posting_from" name="posting_from"
                  value="{{ getValue('posting_from', $objData) }}" onload="enable_date()" type="text" autocomplete="off" placeholder="YY-MM-DD" id="posting_from" readonly>
              </div>

              <label class="col-sm-1 col-form-label">To</label>
              <div class="col-sm-3">
                <input class="form-control posting_to" name="posting_to"
