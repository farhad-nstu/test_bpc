            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="" width="20%">Post</th>
                  <th class="" width="25%">Department</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="25%">{{ $data->desg_title }}</td>
                  <td class="pl-1" width="25%">

                  {{ ($data->working_place == "head_office") ? 'Head Office': 'Commercial Unit' }}
                  </td>
