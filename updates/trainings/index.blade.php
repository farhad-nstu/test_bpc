            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="" width="30%">Course Title</th>
                  <th class="" width="25%">Institute</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center" width="10%">{{ $data->employee_id }}</td>
                  <td class="pl-1" width="30%">{{ $data->course_title }}</td>
                  <td class="pl-1" width="25%">{{ $data->institute }}</td>
