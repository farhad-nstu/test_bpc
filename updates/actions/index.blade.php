            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="" width="20%">Nature of Offense</th>
                  <th class="" width="25%">Date of Offense</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="25%">{{ $data->nature_of_offense }}</td>
                  <td class="pl-1" width="25%">{{ $data->dis_date }}</td>
