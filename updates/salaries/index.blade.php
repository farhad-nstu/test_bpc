      ...
      <div class="card-tools">
        ...
        <button type="button" class="btn btn-tool">
          <a href="{{url($bUrl.'/create')}}" class="btn bg-gradient-info btn-sm custom_btn"><i class="mdi mdi-plus"></i>
            <i class="fa fa-plus-circle"></i> Individual Salary </a>

          <!-- <a href="{{url('hrms/create/salary')}}" class="btn btn-sm btn-info"> <i class="fa fa-plus-circle"></i> Generate Bulk Salary </a> -->
          <a href="{{url('hrms/create/salary-overview')}}" class="btn btn-sm btn-info"> <i class="fa fa-plus-circle"></i> Generate Bulk Salary </a>
        </button>
      </div>
    </div>
            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="sort" data-row="name" id="name" width="20%">Employee</th>
                  <th class="text-center" width="10%">Employee ID</th>
                  <th class="" width="10%">Category</th>
                  <th class="text-center" width="10%">Issue Date</th>
                  <th class="text-right" width="10%">Basic</th>
                  <th class="text-right" width="10%">Addition</th>
                  <th class="text-right" width="10%">Deduction</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="20%">{{ $data->employee_name }}</td>
                  <td class="text-center" width="10%">{{ $data->employee_bpc_id }}</td>
                  <td class="pl-1" width="10%">{{ $data->category_name }}</td>
                  <td class="text-center" width="10%">{{ date('F Y', strtotime($data->salary_date)) }}</td>
                  <td class="text-right pr-1" width="10%">{{ $data->employee_basic_salary }}</td>
                  <td class="text-right pr-1" width="10%">{{ $data->salary_total_addition }}</td>
                  <td class="text-right pr-1" width="10%">{{ $data->salary_total_deductiontion }}</td>
                  <td class="text-right pr-1" width="15%">{{ $data->salary_total }}</td>
