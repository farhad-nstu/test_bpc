            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="" width="20%">Award Title</th>
                  <th class="" width="25%">Award Ground</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1" width="25%">{{ $data->award_title }}</td>
                  <td class="pl-1" width="25%">{{ $data->award_ground }}</td>
