        ...
        <div class="col-md-12">
          <form method="post" action="{{url($bUrl.'/update')}}">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input name="current_salary" id="current_salary" class="form-control" value="{{ getValue('current_salary',$objData) }}">
              </div>
            </div>
              ...
              <table class="table table-bordered" id="ruleTable">
                ...
                @for($i = 0; $i < count($structureData['rule_id']); $i++) 
                  <tr id="ruleRow">
                    ...
                    <td>
                      <input value="{{ $structureData['condition'][$i] }}" name="condition[]" id="condition{{ $i }}" class="form-control text-center">
                    </td>

                    <td>
                      <input value="{{ $structureData['percentage'][$i] }}" name="percentage[]" id="percentage{{ $i }}" class="form-control text-center">
                    </td>
                ...
                <tr id="ruleRow">
                    ...
                    <td>
                      <input value="{{ $structureData['condition'] }}" name="condition[]" id="condition0" class="form-control text-center">
                    </td>

                    <td>
                      <input value="{{ $structureData['percentage'] }}" name="percentage[]" id="percentage0" class="form-control text-center">
                    </td>
              ...
              <table class="table table-bordered" id="deductionRuleTable">
                ...
                @for($i = 0; $i < count($structureDeducData['deductionRule_id']); $i++) 
                  <tr id="deductionRuleRow">
                    ...
                    <td>
                      <input value="{{ $structureDeducData['deductionCode'][$i] }}" name="deductionCode[]" id="deductionCode0" class="form-control text-center">
                    </td>

                    <td>
                      <input value="{{ $structureDeducData['deductionCondition'][$i] }}" name="deductionCondition[]" id="deductionCondition0" class="form-control text-center">
                    </td>

                    <td>
                      <input value="{{ $structureDeducData['deductionPercentage'][$i] }}" name="deductionPercentage[]" id="deductionPercentage0" class="form-control text-center">
                    </td>

                    <td>
                      <input value="{{ $structureDeducData['deductionAmount'][$i] }}" name="deductionAmount[]" id="deductionAmount0" class="form-control text-center">
                    </td>
                ...
                <tr id="deductionRuleRow">
                    ...
                    <td>
                      <input value="{{ $structureDeducData['deductionCondition'] }}" name="deductionCondition[]" id="deductionCondition0" class="form-control text-center">
                    </td>

                    <td>
                      <input value="{{ $structureDeducData['deductionPercentage'] }}" name="deductionPercentage[]" id="deductionPercentage0" class="form-control text-center">
                    </td>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input name="partial_day" id="partial_day" class="form-control" value="{{ getValue('partial_day',$objData) }}">
              </div>
            </div>
...
$(document).ready(function() {
  $('#addMoreRule').on('click', function() {
    ...
    var extChild =
      ...
      j + "' class='form-control text-center'></td><td><input name='condition[]' id='condition" + j +
      "' class='form-control text-center'></td><td><input name='percentage[]' id='percentage" + j +
      "' class='form-control text-center'></td><td><input name='amount[]' id='amount" + j +
  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      if(si < j){
        ...
        $("#condition" + si).val(data.condition);
        $("#percentage" + si).val(data.percentage);
...
//         $("#amount" + j).val(data.amount);
//       } else if(si < j)  {
//         // $("#code" + si).val(data.rules_code);
//         // $("#amount" + si).val(data.rules_amount);
...
$(document).ready(function() {
  $('#addMoreDeductionRule').on('click', function() {
    ...
    var extChild =
      ...
      k + "' class='form-control text-center'></td><td><input name='deductionCondition[]' id='deductionCondition" + k +
      "' class='form-control text-center'></td><td><input name='deductionPercentage[]' id='deductionPercentage" + k +
      "' class='form-control text-center'></td><td><input name='deductionAmount[]' id='deductionAmount" + k +
...
function get_deduc_rules_detail(deducRuleId, dsi) {
  ...
  $.ajax({
    ...
    success: function(data) {
      if(dsi < k) {
        // $("#deductionCode" + dsi).val(data.rules_code);
        // $("#deductionAmount" + dsi).val(data.rules_amount);

        $("#deductionCode" + dsi).val(data.code);
        $("#deductionCondition" + dsi).val(data.condition); 
        $("#deductionPercentage" + dsi).val(data.percentage);
