            ...
            <table class="table table-bordered table-responsive">
              <thead>
                <tr>
                  ...
                  <th class="pl-1">Loan</th>
                  <th class="text-center">Issue Date</th>
                  <th class="text-right">Amount</th>
                  <th class="text-center">Installment</th>
                  <th class="text-center">Running Installment</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="pl-1">{{$data->employee_name}}</td>
                  <td class="text-center">{{$data->employee_bpc_id}}</td>
                  <td class="pl-1">{{$data->loan_title}}</td>
                  <td class="text-center">{{ date('F Y', strtotime($data->loan_date)) }}</td>
                  <td class="text-right pr-1">{{ $data->amount }}</td>
